...
<div id="page-wrap">
    ...
    <div class="container-wrap">
      <div class="content-sidebar-wrap">
        <div id="content">
          ...
          <?php if (theme_get_setting('breadcrumbs', 'alpha_responsive_theme')): ?>
            <div id="breadcrumbs">
  ...
  <div class="footer_credit">
    <!-- Social Links -->
    <?php if (theme_get_setting('social_links', 'alpha_responsive_theme')): ?>
      <div class="social-icons">
       <ul>
        <li><a class="rss" href="<?php print $front_page; ?>rss.xml"><i class="fa fa-rss"></i></a></li>
        <li><a class="fb" href="<?php echo theme_get_setting('facebook_profile_url', 'alpha_responsive_theme'); ?>" target="_blank" rel="me"><i class="fa fa-facebook"></i></a></li>
        <li><a class="twitter" href="<?php echo theme_get_setting('twitter_profile_url', 'alpha_responsive_theme'); ?>" target="_blank" rel="me"><i class="fa fa-twitter"></i></a></li>
        <li><a class="gplus" href="<?php echo theme_get_setting('gplus_profile_url', 'alpha_responsive_theme'); ?>" target="_blank" rel="me"><i class="fa fa-google-plus"></i></a></li>
        <li><a class="linkedin" href="<?php echo theme_get_setting('linkedin_profile_url', 'alpha_responsive_theme'); ?>" target="_blank" rel="me"><i class="fa fa-linkedin"></i></a></li>
        <li><a class="pinterest" href="<?php echo theme_get_setting('pinterest_profile_url', 'alpha_responsive_theme'); ?>" target="_blank" rel="me"><i class="fa fa-pinterest"></i></a></li>
        <li><a class="youtube" href="<?php echo theme_get_setting('youtube_profile_url', 'alpha_responsive_theme'); ?>" target="_blank" rel="me"><i class="fa fa-youtube"></i></a></li>
       </ul>
      </div>
    <?php endif; ?>
